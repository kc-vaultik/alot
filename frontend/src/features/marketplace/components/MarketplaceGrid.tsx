...
interface MarketplaceGridProps {
  cards: (CollectCard | MarketplaceListing)[];
  onCardSelect?: (card: CollectCard | MarketplaceListing) => void;
}
...
export const MarketplaceGrid = memo(({ cards, onCardSelect }: MarketplaceGridProps) => {
  if (cards.length === 0) {
    return (
      <div className="text-center py-20">
        <p className="text-white/40 mb-6">No cards available for trade</p>
      </div>
    );
  }
